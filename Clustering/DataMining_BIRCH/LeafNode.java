...
class LeafNode extends ClusteringFeature {
    ...
    ArrayList<Cluster> getClusterChilds(){
    ...
    private LeafNode[] divideLeafNode(){
        ...
        for (Cluster c : clusterChilds) {
            if ((cluster1 != null ? cluster1.computerClusterDistance(c) : 0) < (cluster2 != null ? cluster2
    ...
    public void addingCluster(ClusteringFeature clusteringFeature){
        ...
        if (clusterChilds == null) {
            ...
            ArrayList<double[]> data1 = null;
            if (findedCluster != null) {
                data1 = (ArrayList<double[]>) findedCluster
                        .getData().clone();
            }
