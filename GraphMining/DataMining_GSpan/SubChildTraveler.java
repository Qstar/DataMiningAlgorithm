...
class SubChildTraveler {
    // 当前的五元组边
    private ArrayList<Edge> edgeSeq;
    // 当前的图
    private Graph graph;
    // 结果数据，孩子边对所属的图id组
    private ArrayList<Edge> childEdge;
    // 图的点id对五元组id标识的映射
    private int[] g2s;
    // 五元组id标识对图的点id的映射
    private int[] s2g;
    ...
    SubChildTraveler(ArrayList<Edge> edgeSeq, Graph graph){
     ...
     */
    private void dfsSearchEdge(int currentPosition){
        int rmPosition;
     ...
     * 获取结果数据对
     */
    ArrayList<Edge> getResultChildEdge(){
