...
class CARTTool {
    ...
    CARTTool(ArrayList<String[]> dataArray){
     ...
     */
    private void readData(ArrayList<String[]> dataArray){
    ...
    private void buildDecisionTree(TreeNode node, String parentAttrValue,
