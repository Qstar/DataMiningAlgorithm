...
class Graph {
    ...
    Graph(int[][] edges, ArrayList<Point> points){
        this.edges = edges;
        this.points = points;
    }
     ...
     * @param length 距离阈值
     */
    ArrayList<Graph> splitGraphByLength(int length){
        int[][] edges;
        Graph tempGraph;
     ...
     */
    private void divideGraph(ArrayList<Point> pointList){
        // 判断此坐标点集合是否能够被分割
        boolean canDivide = false;
        ArrayList<ArrayList<Point>> pointGroup;
        ArrayList<Point> pointList1;
        ArrayList<Point> pointList2;
     ...
     * 获取分裂得到的聚类结果
     */
    ArrayList<ArrayList<Point>> getClusterByDivding(){
